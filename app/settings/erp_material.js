...
saveBtn.addEventListener('click', function (event) {
  let erpMaterial = document.getElementById('erp-material').value;
  var erpMaterialDoc = { type: 'erp_material', name: `${erpMaterial}`}
  db.insert(erpMaterialDoc, function(err, newDocs) {
    console.log("err doc", JSON.stringify(err));
    console.log("erp material", JSON.stringify(newDocs));
  });
...
var readData = function() {
  ...
  db.find({type: 'erp_material'}, function (err, docs) {
